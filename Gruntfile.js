  ...
  grunt.initConfig({
    ...
    shell: {
      debug: {
        ...
        command: 'set NODE_PATH=. node --debug-brk application.js' // replace all env to set
      },
      unit: {
        options: {
          stdout: true,
        ...
        command: 'set NODE_PATH=. ./node_modules/.bin/mocha -A -u exports --recursive test/unit/'
      },
      accept: {
        options: {
          stdout: true,
        ...
        command: 'set NODE_PATH=. ./node_modules/.bin/mocha -A -u exports --recursive test/server.js test/accept/'
      },
      coverage_unit: {
        options: {
          stdout: true,
